...
import { fetchCurrencies, processOCR, submitExpense, uploadMultipleFiles } from '../services/api';
...
const SubmitExpense = () => {
  ...
  const handleFileUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (firstFile.type.startsWith('image/')) {
      ...
      try {
        ...
        setExpenseDate(result.result.date);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: 'Your expense has been created as a draft.',
      });
  ...
  const currencyOptions = currencies.map(c => ({
    ...
    label: `${c.currencyCode} - ${c.countryName}`,
  }));
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="flex gap-4 pt-4">
                <Button type="submit" className="flex-1" disabled={isProcessingOCR || isSubmitting}>
                  {isSubmitting ? (
                    <>
